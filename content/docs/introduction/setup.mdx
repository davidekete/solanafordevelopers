...
<Callout title="Info">You can skip this step if you already have Rust installed.</Callout>
<Steps>
<Step>
...
<Callout title="Info">
  If you’re using a Windows machine, consider these <LinkPrev href={"https://forge.rust-lang.org/infra/other-installation-methods.html"}>alternative methods for installing Rust</LinkPrev>.
</Callout>
</Step>
